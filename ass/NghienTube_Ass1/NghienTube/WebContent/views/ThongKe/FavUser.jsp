...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-9">
			<form action="/NghienTube/favUser" method="post">
				<input type="text" class="form-control" name="vid" placeholder="Video Title?" style="width: 50%; margin: 20px auto;">
				<button formaction="/NghienTube/favUser">Tìm kiếm</button>
				</form>
