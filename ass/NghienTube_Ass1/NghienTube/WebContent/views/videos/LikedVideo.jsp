...
<body>
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand"
					href="/NghienTube/user/index?page=0">
					<img
		...
		<div class="row">
			<div class="col-9">
				<div class="row row-cols-3 row-cols-lg-3 g-3 g-lg-3" style="margin-bottom: 100px">
					<c:forEach var="item" items="${video}">
						<div class="col">
							<div class="p-3 border bg-light" style="height: 362px">
								<a
									href="http://localhost:8080/NghienTube/views/videos/Trangchitiet.jsp">
									<div>
										<iframe width="280" height="186" src="${item.poster}"
			...
			<div class="col-3">
				<ul class="nav flex-column">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="/NghienTube/user/likedVideo">Video đã thích</a></li>
					<li class="nav-item"><a class="nav-link" href="#">Video đã
							chia sẻ</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="footer">Hi cáº£ nhÃ </div>
</body>
